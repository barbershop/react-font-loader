(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.FontLoader = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
var FontLoader = (function (_Component) {
	...
	_createClass(FontLoader, [{
		...
		value: function loadFonts(fontProvider, stylesToLoad) {
			...
			var onInactive = _props2.onInactive;
			var onLoading = _props2.onLoading;
			var fontIsLoading = _props2.fontIsLoading;
			...
			WebFont.load((_WebFont$load = {}, _defineProperty(_WebFont$load, fontProvider, {
				...
				urls: customUrls || {},
				text: text
			}), _defineProperty(_WebFont$load, 'loading', function loading() {
				if (debug) console.info('…Loading WebFonts');
				onLoading();
			}), _defineProperty(_WebFont$load, 'active', function active() {
				if (debug) console.info('WebFonts are Active!');
				onActive();
			}), _defineProperty(_WebFont$load, 'inactive', function inactive() {
				if (debug) console.warn('WebFonts Failed to Load 😱');
				onInactive();
			}), _defineProperty(_WebFont$load, 'fontloading', function fontloading(familyName, fvd) {
			...
			}), _defineProperty(_WebFont$load, 'classes', false), _defineProperty(_WebFont$load, 'timeout', timeout), _WebFont$load));
		}
	}, {
		key: 'render',
...
FontLoader.defaultProps = {
	fonts: {},
	fontIsLoaded: function fontIsLoaded() {},
	fontIsLoading: function fontIsLoading() {},
	fontLoadFailed: function fontLoadFailed() {},
